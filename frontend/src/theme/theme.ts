...
// Dark mode colors
const darkBackgroundDefault = "#0f0f0f";
const darkBackgroundPaper = "#1a1a2e";
const darkSurfaceColor = "#16213e";

// Light mode colors
const lightBackgroundDefault = "#ffffff";
const lightBackgroundPaper = "#f5f5f5";
const lightSurfaceColor = "#ffffff";
      ...
      MuiTooltip: {
        styleOverrides: {
          tooltip: {
            backgroundColor: alpha(backgroundPaper, 0.95),
            backdropFilter: "blur(10px)",
            border: `1px solid ${alpha(textPrimary, isDark ? 0.1 : 0.1)}`,
            borderRadius: 8,
          },
        },
      },
